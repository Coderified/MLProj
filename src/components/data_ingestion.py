# in actual proj, data sources are varied - from big data, cloud, etc...
# here data ingestion is important 
# test train spli is done here 
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info("Data has been Read as df")
